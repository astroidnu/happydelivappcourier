 ...
 */
@Module
class NetworkModule(private val happyDelivCourier: HappyDelivCourier){

    @Provides
    @Singleton
    fun provideOkhttpClient(): OkHttpClient {
        val httpCacheDirectory = File(happyDelivCourier.cacheDir, "httpCache")
    ...
    private val rewriteRresponseInterceptorOffline = Interceptor { chain ->
        ...
        if (!appUtils.isConnectingToInternet(happyDelivCourier.applicationContext)) {
